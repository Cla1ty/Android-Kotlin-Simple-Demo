...
import com.dwiariyanto.androidkotlinsimpledemo.core.saveandresore.ISaveAndRestoreForData
...
import com.dwiariyanto.androidkotlinsimpledemo.view.dialog.LoadingDialog
...
abstract class BaseFragment : Fragment()
{
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?)
    {
        ...
        setupForToolbar.titleUse = if (setupForToolbar.titleRes != 0) getString(setupForToolbar.titleRes) else setupForToolbar.title
    ...
    override fun onSaveInstanceState(outState: Bundle)
    {
        ...
        if (this is ISaveAndRestoreForParam<*>) this.doSaveInstanceStateForParam(outState)
        if (this is ISaveAndRestoreForData<*>) this.doSaveInstanceStateForData(outState)
    }
    ...
    override fun onViewStateRestored(savedInstanceState: Bundle?)
    {
        ...
        if (this is ISaveAndRestoreForParam<*>) this.doViewStateRestoredForParam(savedInstanceState)
        if (this is ISaveAndRestoreForData<*>) this.doViewStateRestoredForData(savedInstanceState)
    }
